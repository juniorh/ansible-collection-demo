...
requirements:
    - python >= 3.0
author: "ri24l_pwt@yahoo.com (@juniorh)"
options:
    custom_opt_1:
        description:
    ...
    custom_opt_2:
        ...
        required: true
    custom_opt_3:
        description: This is a description of custom_opp_3
        type: int
    custom_opt_4:
...
def run_module():
    module = AnsibleModule(
        argument_spec=dict(
            ...
            custom_opt_3=dict(type='int', required=False),
            custom_opt_4=dict(type='str', required=False, default='present', choices=['absent', 'present']),
            custom_opt_5=dict(type='dict', required=False),
            custom_opt_6=dict(type='dict', required=False),
        ),
